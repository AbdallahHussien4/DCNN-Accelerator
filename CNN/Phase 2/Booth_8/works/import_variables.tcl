...
##########################################################################################################################
set MGC_importVerilogNetlist "/home/vlsi/Desktop/Lab3PnR/Outputs_BoothMult/verilog/Booth_Synth.v"                     ; # REQUIRED: Path to vg netlist.  Multiple files/wildcards allowed, but must 
                                                      #           match vg files only. NOT REQUIRED FOR mxdb flow.
set MGC_topDesign            "Booth_Multiplier"                     ; # REVIEW  : Name of top level module in verilog netlist(s).
set MGC_nrf_floorplanning    "auto"                     ; # REVIEW  : Type floorplanning to be performed: auto | manual | none
#set MGC_floorLoadDefFile     "/home/vlsi/Desktop/Lab3PnR/outputs_adder/floorplan/demo_ripple_adder.def"                     ; # REVIEW  : Path to floorPlan def if available
