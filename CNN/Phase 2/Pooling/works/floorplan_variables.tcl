...
set fp_units            micro
set fp_top_partition    "Pooling_2x2"         ; # INPUT REQUIRED: Top partition name
...
# PG ring settings
set pg_ring_layers              {metal8 metal7}          ; # Metal layers for the rings in order {Hlayer Vlayer}
...
set pg_ring_widths              { 0.4000u 0.4000u}     ; # Width of the supply rings
set pg_ring_spacing             0.4000u          ; # Spacing between supply rings
set pg_ring_step                1.6u           ; # Spacing between ring patterns
set pg_ring_offset_left	        0.14u	        ; # Spacing from left chip edge to ring
set pg_ring_offset_right        0.14u	        ; # Spacing from right chip edge to ring
set pg_ring_offset_top	        0.14u	        ; # Spacing from top of chip to ring
set pg_ring_offset_bottom       0.14u          ; # Spacing from bottom of chip to ring

set pg_stripe_vlayers	        {metal8}	    ; # Layers for vertical stripes, e.g. {METAL5}
set pg_stripe_hlayers	        {metal7}	    ; # Layers for horizontal stripes, e.g. {METAL6}
...
set pg_stripe_widths	        {0.4u 0.4u}	; # Width of stripes
set pg_stripe_spacing	        0.4u       ; # Spacing between stripes
set pg_stripe_step              1.6u      ; # Step spacing for repeating patterns
set pg_stripe_offset_left       1.74u		; # Offset from left side of chip to start vertical stripe patterns
set pg_stripe_offset_right      1.74u		; # Offset from right side of chip to stop vertical stripe patterns
set pg_stripe_offset_top        1.74u		; # Offset from top of chip to stop horizontal stripe patterns
set pg_stripe_offset_bottom     1.74u		; # Offset from bottom of chip to start horizontal stripe patterns
set pg_stripe_start_vmargin     0.14u		; # Offset from bottom of chip to beginning of vertical stripes
set pg_stripe_stop_vmargin      0.14u		; # Offset from top of chip to end vertical stripes
set pg_stripe_start_hmargin     0.94u		; # Offset from left side of chip to start horizontal stripes
set pg_stripe_stop_hmargin      0.94u		; # Offset from right side of chip to stop horizontal stripes
