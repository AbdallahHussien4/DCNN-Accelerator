...
##########################################################################################################################
set MGC_importVerilogNetlist "/home/vlsi/Desktop/Lab3PnR/Outputs_Pooling/verilog/Pooling_Synth.v"                     ; # REQUIRED: Path to vg netlist.  Multiple files/wildcards allowed, but must 
                                                      #           match vg files only. NOT REQUIRED FOR mxdb flow.
set MGC_topDesign            "Pooling_2x2"                     ; # REVIEW  : Name of top level module in verilog netlist(s).
